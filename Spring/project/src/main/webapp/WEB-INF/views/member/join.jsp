...
<body>
	<div class="sub">
		<div class="size">
			...
			<form name="frm" id="frm" action="join" method="post" onsubmit="return loginCheck();)"
					...
					<tbody>
						<tr>
							...
							<td><input type="text" name="email" id="email"
								...
								class="email_check"><a href="javascript:emailCheck();"
									class="btn bgGray"
									style="float: left; width: auto; clear: none;">중복확인</a></span></td>
						</tr>
						<tr>
							<th>*비밀번호</th>
							<td><input type="password" name="pwd" id="pwd"
								style="float: left;"> <span class="ptxt">비밀번호는
									숫자, 영문 조합으로 8자 이상으로 입력해주세요.</span></td>
						</tr>
						<tr>
